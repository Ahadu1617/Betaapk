...
b="\033[1;34m"
w="\033[0m"
echo -e $b">"$w" Betaransom - Is an Android device ransomware and this script will install dependency modules in your machine be patient...."
...
echo -e $b">"$w" use command "$g"python3 betaransom.py"$w" for start the console"